export default class createPhotographer {
    ...
    createPhotographer(data) {
     // Get the main elements where we will insert the profiles
     ...
     let currentTag = window.location.href.split('#')[1];
       ...
       // For photographers in data we create an article
        data.photographers.forEach(photographer => {
            ...
            photographer.tags.forEach(tag => {
                //If the tag corresponds to the current one , we filter it and we create the focused tag
            ...
            let articleTemplate = `<article class ="photographer-article"></article>
            <a class = "photographer-link" href= "photographer.html? id= ${ photographer.id}" title= "${photographer.name} profile"></a>
                ...
                //Insertion of the created article into main
